...
class CreateTablesBlogs extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('blogs_categories_translations', function(Blueprint  $table){
            $table->increments('id');
            $table->integer('blog_category_id')->unsigned();
            $table->foreign('blog_category_id')->references('id')->on('blogs_categories')->onDelete('cascade');
            $table->char('locale', 10)->index();
